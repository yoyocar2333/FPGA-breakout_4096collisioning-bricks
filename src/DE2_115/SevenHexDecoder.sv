...
parameter DA = 7'b0001000; // A
parameter DB = 7'b0000011; // b
parameter DC = 7'b1000110; // C
parameter DD = 7'b0100001; // d
parameter DE = 7'b0000110; // E
parameter DF = 7'b0001110; // F
always_comb begin
	case(i_hex)
